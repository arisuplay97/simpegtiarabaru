              ...
              <div key={group.label} className="mb-1">
                ...
                {(isMobileMode || !collapsed) && (
                  <button
                    ...
                    className={cn(
                      "flex w-full items-center justify-between rounded-lg px-2.5 py-1.5 mt-2 first:mt-0 transition-colors",
                      hasActive ? "text-slate-700 dark:text-zinc-300 font-semibold" : "text-slate-400 dark:text-zinc-500 hover:text-slate-600 dark:hover:text-zinc-300"
                    )}
                  >
