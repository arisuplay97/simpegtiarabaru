      ...
      create: {
        ...
        pegawai: {
          create: {
            ...
            pangkat: emp.pangkat,
            status: emp.status.toUpperCase() as any,
            sp: emp.sp as any,
            email: emp.email,
            telepon: emp.telepon,
            ...
            agama: emp.agama.toUpperCase() as any,
            statusNikah: emp.statusNikah === "Menikah" ? "MENIKAH" : (emp.statusNikah === "Cerai" ? "CERAI" : "BELUM_MENIKAH"),
            alamat: emp.alamat,
            npwp: emp.npwp,
            bank: emp.bank,
            noRekening: emp.noRekening,
            bpjsKesehatan: emp.bpjsKes,
            bpjsKetenagakerjaan: emp.bpjsTK,
